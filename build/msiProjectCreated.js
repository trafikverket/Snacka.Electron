 ...
 *
 *   msiexec /i snacka.msi DISABLE_AUTO_UPDATES=1 /qn
 *
...
exports.default = async function msiProjectCreated(projectFile) {
  ...
  const propertyAndActions = `
    ...
    <!-- SET_DEFAULT_ASSOCIATIONS: enterprise property to wire the Windows
         ...
         tel:/callto: default to Snacka without admins authoring the
    ...
    <CustomAction Id="WriteDefaultAssociationsPolicy"
      ...
      <![CDATA[
        ...
        xmlPath = installDir & "resources\\SnackaDefaultAppAssociations.xml"
        policyKey = "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\System\\DefaultAssociationsConfiguration"
        sentinelKey = "HKLM\\SOFTWARE\\Snacka\\InstallState\\WroteDefaultAssociationsPolicy"
    ...
    <CustomAction Id="CleanupDefaultAssociationsPolicy"
      ...
      <![CDATA[
        ...
        If Len(installDir) > 0 Then
          If Right(installDir, 1) <> "\\" Then installDir = installDir & "\\"
          expectedXmlPath = installDir & "resources\\SnackaDefaultAppAssociations.xml"
          policyKey = "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\System\\DefaultAssociationsConfiguration"
          sentinelKey = "HKLM\\SOFTWARE\\Snacka\\InstallState\\WroteDefaultAssociationsPolicy"
    ...
    <CustomAction Id="WriteTelephonyCapabilities"
      ...
      <![CDATA[
        ...
        exePath = Chr(34) & installDir & "Snacka.exe" & Chr(34) & " " & Chr(34) & "%1" & Chr(34)

        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\", "URL:Snacka Telephony", "REG_SZ"
        If Err.Number <> 0 Then
          writeErr = Err.Description
          Err.Clear
          Err.Raise 1, "WriteTelephonyCapabilities", "Failed to write HKLM\\SOFTWARE\\Classes\\Snacka.tel: " & writeErr
        End If
        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\URL Protocol", "", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\DefaultIcon\\", installDir & "Snacka.exe,0", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\shell\\open\\command\\", exePath, "REG_SZ"

        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\", "URL:Snacka Telephony", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\URL Protocol", "", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\DefaultIcon\\", installDir & "Snacka.exe,0", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\shell\\open\\command\\", exePath, "REG_SZ"

        shell.RegWrite "HKLM\\SOFTWARE\\Snacka\\Capabilities\\ApplicationName", "Snacka", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Snacka\\Capabilities\\ApplicationDescription", "Snacka Desktop", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Snacka\\Capabilities\\ApplicationIcon", installDir & "Snacka.exe,0", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Snacka\\Capabilities\\URLAssociations\\tel", "Snacka.tel", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\Snacka\\Capabilities\\URLAssociations\\callto", "Snacka.callto", "REG_SZ"
        shell.RegWrite "HKLM\\SOFTWARE\\RegisteredApplications\\Snacka", "Software\\Snacka\\Capabilities", "REG_SZ"
        If Err.Number <> 0 Then
          writeErr = Err.Description
          Err.Clear
          Err.Raise 1, "WriteTelephonyCapabilities", "Failed to write HKLM\\SOFTWARE\\RegisteredApplications\\Snacka: " & writeErr
        End If
      ]]>
    </CustomAction>
    ...
    <CustomAction Id="CleanupTelephonyCapabilities"
      ...
      <![CDATA[
        ...
        shell.RegDelete "HKLM\\SOFTWARE\\RegisteredApplications\\Snacka"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Snacka\\Capabilities\\URLAssociations\\tel"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Snacka\\Capabilities\\URLAssociations\\callto"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Snacka\\Capabilities\\ApplicationName"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Snacka\\Capabilities\\ApplicationDescription"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Snacka\\Capabilities\\ApplicationIcon"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\shell\\open\\command\\"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\DefaultIcon\\"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\URL Protocol"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.tel\\"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\shell\\open\\command\\"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\DefaultIcon\\"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\URL Protocol"
        Err.Clear
        shell.RegDelete "HKLM\\SOFTWARE\\Classes\\Snacka.callto\\"
        Err.Clear
      ]]>
    </CustomAction>`;
